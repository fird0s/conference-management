            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <?php echo form_open('account/login', array('id'=>'login-form')); ?>
                  ...
                  <!-- <a href="#" class="forgot-pass">Forgot Password?</a> <br> --><small>Do not have an account? </small><a href="<?php echo base_url()?>index.php/account/register" class="signup">Register</a>
                </div>
              </div>
            </div>
          </div>
