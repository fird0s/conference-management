                            ...
                            <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="actions center">
                                  <a href="<?php echo base_url('index.php/account/edit_paper/')?><?php echo $data['id'] ?>"   data-toggle="tooltip" title="Edit"  class="btn btn-primary btn-mini"> edit</a>
                                  <a href="<?php echo base_url('index.php/account/delete_paper/')?><?php echo $data['id'] ?>" onclick="return confirm('Are you sure deleted this paper?');" data-effect="mfp-move-from-top" data-toggle="tooltip" title="Delete"  class="btn btn-danger btn-mini fa fa-trash-o"> delete</a>
                                  </td>
                              </tr>
                              <?php } ?>
                             </tbody>
