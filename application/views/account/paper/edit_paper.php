              ...
              <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <?php echo form_open_multipart('account/edit_paper/'.$paper->id, array('class'=>'form-horizontal')); ?>
                        <div class="line"></div>
                        <div class="form-group">
                          <label class="form-control-label">Title</label>
                          <input type="text" name="title" value="<?php echo $paper->title ?>" placeholder="Your paper title" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                          <label>Change file (pdf, doc, docx, ppt or pptx)</label>
                            <a href="<?php echo base_url()?>uploads/papers/<?php echo $paper->file ?>" data-toggle="tooltip" class="btn "> Download</a><br>
