          ...
          <section class="dashboard-counts no-padding-bottom">
            <div class="container-fluid">
              ...
              <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      <?php echo form_open_multipart('administrator/send_mail/'.$member->id, array('class'=>'form-horizontal')); ?>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="" class="form-control" value="<?php echo $member->email ?>">
                        </div>
