    ...
    <div class="page home-page">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class="active"> <a href="<?php echo base_url()?>index.php/administrator/participants"><i class="icon-user"></i>Participants</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Participants</h2>
            </div>
          </header>
                      ...
                      <table id="partcipants" class="display" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th class="no-sort">Surname</th>
                              <th>Role</th>
                              <th class="no-sort"> Place of Work</th>
                         ...
                         <tbody>
                          ...
                          <tr>
                            ...
                            <td class="actions center">
                               <a href="<?php echo base_url('index.php/administrator/edit_participant/')?><?php echo $data['id'] ?>" data-effect="mfp-move-from-top"  data-toggle="tooltip" title="View participant"  class="btn btn-primary btn-mini"> view</a>          
                               <a href="<?php echo base_url('index.php/administrator/delete_participant/')?><?php echo $data['id'] ?>" onclick="return confirm('Are you sure deleted this participant?');" data-effect="mfp-move-from-top" data-toggle="tooltip" title="view partcipant"  class="btn btn-danger btn-mini"> delete</a>          
                            </td>
                          </tr>
                           <?php } ?>
                         </tbody>
