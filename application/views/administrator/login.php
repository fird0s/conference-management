...
<html>
  <head>
    ...
    <title>Administrator Login - <?php echo $this->config->item('title') ?></title>
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <?php echo form_open('administrator/login', array('id'=>'login-form')); ?>
                    ...
                    <input id="register" type="submit" name="submit" value="Login" class="btn btn-primary">
