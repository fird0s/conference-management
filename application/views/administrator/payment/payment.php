      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="<?php echo base_url()?>index.php/administrator/payments"><i class="icon-check"></i>Payments</a></li>
                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <table id="payments" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th class="no-sort"><b>Name</b></th>
                                        <th class="no-sort"><b>Surname</b></th>
                                        <th><b>Amount</b></th>
                                        <th><b>Status</b></th>
                                ...
                                <tbody>
                                  <?php foreach ($payments->result_array() as $data) { ?>
                                  <tr>
                                     <td><?php echo $data['name'] ?></td>
                                     <td><?php echo $data['surname'] ?></td>
                                     <td><?php echo $data['amount'] ?> <?php if ($data['currency'] === '0'): ?>EUR<?php elseif ($data['currency'] === '1'): ?>USD<?php endif; ?> </td>
                                     <td><?php if ($data['status'] === '0'): ?>Unconfirmed<?php elseif ($data['status'] === '1'): ?>Confirmed<?php endif; ?></td>
                                     <td><?php if ($data['account_status'] === '0'): ?>Unbooked<?php elseif ($data['account_status'] === '1'): ?>Booked<?php endif; ?></td>
                                     <td class="actions center">
                                            <a <?php if ($data['account_status']  === '1'): ?>onclick="return false;" <?php elseif ($data['account_status']  === '0'): ?>onclick="return confirm('Are you sure confirm payment, it will change account status to Booked?');" href="<?php echo base_url('index.php/administrator/confirm_payment/')?><?php echo $data['id'] ?>"<?php endif; ?> class="btn btn-primary btn-mini <?php if ($data['account_status'] === '1'): ?>disabled<?php endif; ?>">Confirm Payment</a>
                                      </td>
                                  </tr>
                                  <?php } ?>
                                 </tbody>
