              ...
              <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <?php echo form_open('administrator/edit_expense/'.$expense->id, array('class'=>'form-horizontal')); ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" rows="7" id="expense_desc" name="expense_desc" required><?php echo $expense->description ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" type="number" class="form-control" name="amount" value="<?php echo $expense->amount ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9 date-expense">
                            <input type="input" class="form-control" data-date-format='yyyy-mm-d' value="<?php echo $expense->date?>" name="date" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-4 offset-sm-3">
                            <button type="submit" class="btn btn-primary" name="submit">Edit Expense</button>
                          </div>
                        </div>
