    ...
    <div class="page home-page">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class="active"> <a href="<?php echo base_url()?>index.php/administrator/paper"><i class="icon-presentation"></i>Paper</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Papers</h2>
            </div>
          </header>
              ...
              <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif?>
                        <table id="paper" class="display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th><b>Author</b></th>
                                    <th><b>Title</b></th>
                                    <th><b>Date Entry</b></th>
                                    <th><b>Status</b></th>
                                    <th class="center" style="width: 20%;"><b>Action</b></th>
                                </tr>
                            </thead>
                            <tbody>
                              <?php foreach ($papers->result_array() as $data) { ?>
                              <tr>
                                 <td><?php echo $data['name'] ?> <?php echo $data['surname'] ?></td>
                                 <td><?php echo $data['title'] ?></td>
                                 <td><?php echo nice_date($data['date_created'], 'Y/m/d') ?></td>
                                 <td><b>
                                     <?php if ($data['paper_status'] === '0'): ?>
                                      unreviewed
                                  <?php elseif ($data['paper_status'] === '1'): ?>
                                      summary inserted 
                                  <?php elseif ($data['paper_status'] === '2'): ?>    
                                     subject acceptance
                                  <?php elseif ($data['paper_status'] === '3'): ?>    
                                      reviewed – ready to print
                                  <?php elseif ($data['paper_status'] === '4'): ?>     
                                      rejected<
                                  <?php else: ?>
                                 ...
                                 <td class="actions center">
                                      <a href="<?php echo base_url('index.php/administrator/edit_paper/')?><?php echo $data['id'] ?>"  data-effect="mfp-move-from-top" data-toggle="tooltip" title="Hapus"  class="btn btn-primary btn-mini fa fa-trash-o"> edit</a>
                                      <a href="<?php echo base_url('index.php/administrator/delete_paper/')?><?php echo $data['id'] ?>" onclick="return confirm('Are you sure deleted this paper?');" data-effect="mfp-move-from-top" data-toggle="tooltip" title="Delete"  class="btn btn-danger btn-mini fa fa-trash-o"> delete</a>
                                 </td>
                              </tr>
                              <?php } ?>
                             </tbody>
